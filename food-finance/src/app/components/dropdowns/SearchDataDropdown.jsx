...
function SearchDataDropdown({ data, value, onChange, title }) {
    ...
    const handleSearchChange = (e) => {
        ...
        setSearchTerm(term);
        onChange(''); // Clear the selected value when user starts typing
        if (term.length >= 1) {
            setFilteredData(
                data.filter(item =>
    ...
    return (
        <div className="relative inline-block mx-2 bg-white justify-between" ref={dropdownRef}>
            ...
            <div className="flex border rounded-md w-96">
                <input
                    ...
                    }} // Open the dropdown if already typed at least 1 character
                    placeholder="Select an option"
                    className="px-4 py-2 bg-white text-gray-500 rounded-l-md focus:outline-none hover:text-gray-600 w-96"
                    ref={inputRef}
                ...
                <button
                    ...
                    className="px-4 py-2 w-12 bg-white text-gray-500 rounded-r-md border-l border-gray-300 focus:outline-none hover:text-gray-600"
                >
                    <svg
...
export default SearchDataDropdown;
